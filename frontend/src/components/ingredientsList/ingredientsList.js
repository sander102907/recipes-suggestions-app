        ...
        <div className="ingredients" style={{'maxHeight': maxHeight}}>
            <h5 className='ingredients-title'>Ingredients</h5>
                ...
                {props.groups.map((group, group_index) => {
                    return (<div className="ingredient-group" key={group_index}>
                        ...
                        return (
                            <div className="ingredient-item" key={ingredient_index}>
                                    ...
                                    <div className='ingredient-item-info'>
                                        ...
                                        <div className="ingredient-item-info-right">
                                            <div className='ingredient-item-info-right-buttons'>
                                                {props.onOr != null ? <div className='ingredient-item-or' onClick={() => props.onOr(group_index)}>
                                                    <Badge bg="info">OR</Badge>
                                                </div> : null}
                                                {props.onRemove != null ? <div className='ingredient-item-close' onClick={() => props.onRemove(group_index, ingredient_index)}>
                                                    <XLg />
                                                </div> : null}
                                            </div>
                                ...
                                {ingredient_index < group.ingredients.length - 1 ? 'OR' : null}
                            </div>                            
                        );
                    })}
                </div>
