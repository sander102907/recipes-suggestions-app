const initDatabase = (db) => {    
    ...
    const ingredientsTable = "CREATE TABLE IF NOT EXISTS ingredient(id int(11) NOT NULL AUTO_INCREMENT, ah_id int(11), ah_bonus_id int(11), name varchar(50) NOT NULL, PRIMARY KEY (id)) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;"
